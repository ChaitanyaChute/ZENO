...
export default function SignInPage() {
  ...
  return (
    <main className="relative min-h-screen w-full bg-[#030303] text-white overflow-hidden flex items-center justify-center px-4 py-12">
      {/* Grid overlay */}
      ...
      {/* Lime glow blob */}
      <div className="pointer-events-none absolute left-1/2 top-[-8rem] h-[36rem] w-[36rem] -translate-x-1/2 rounded-full bg-lime-300/15 blur-3xl" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-8 shadow-[0_30px_120px_rgba(0,0,0,0.5)] backdrop-blur-xl sm:p-10">
          ...
          <p className="mt-4 text-sm leading-7 text-white/55">
            Continue your journey with Zeno. Access your portfolio and analytics.
          </p>
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link
                  href="#"
                  className="text-xs text-lime-300/70 transition hover:text-lime-300"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            {/* Remember me */}
            <label className="flex cursor-pointer items-center gap-3 text-sm text-white/50 select-none">
              <div className="relative flex items-center">
                ...
                />
                <div className="h-4 w-4 rounded border border-white/20 bg-white/[0.03] transition peer-checked:border-lime-300/60 peer-checked:bg-lime-300/20" />
              </div>
